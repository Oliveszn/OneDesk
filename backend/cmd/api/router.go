...
func newRouter(authHandler *auth.Handler, tenancyHandler *tenancy.Handler, billingHandler *billing.Handler, inventoryHandler *inventory.Handler, tokenService *token.JWTService) *chi.Mux {
	r := chi.NewRouter()
